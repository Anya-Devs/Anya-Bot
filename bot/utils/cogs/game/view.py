...
from bot.utils.cogs.cover_art import CoverArtVariantView, CoverArtDatabase
...
class CharacterInfoView(discord.ui.View):
    ...
    def __init__(self, cog, character: dict, uid: str, user: discord.Member, draws_left: int = 0, guild_id: str = None, session_claims: int = 0):
...
class GachaClaimView(discord.ui.View):
    ...
    def __init__(self, cog, user: discord.Member, guild_id: str, characters: list, balance: int, draws_left: int, is_out_of_draws: bool, message=None, is_dev_drop: bool = False, session_claims: int = 0):
        ...
        self.session_claims = session_claims  # Track total claims in this session
    ...
    async def claim_character(self, interaction: discord.Interaction, index: int):
        ...
        # Create info view for the claimed character - pass session_claims forward
    ...
    async def redraw_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Create new view with updated data - pass session_claims forward
        new_view = GachaClaimView(self.cog, self.user, guild_id, new_characters, new_balance, new_draws_left, new_is_out_of_draws, message=interaction.message, session_claims=self.session_claims)
