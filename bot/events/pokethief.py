            ...
            if who_caught_id in quest_user_ids:
                ...
                if hunter:
                    ...
                    if event_type == "shiny":
                        ...
                        emoji_title = ":sparkles: Congratulations!"
                    else:  # collection
                        descriptions = [
                            "Great catch, <@{user_id}>! Your collection is growing!",
                            "Well done, <@{user_id}>! Keep building that collection.",
                            "Nice work, <@{user_id}>! Another one for the collection!",
                            "Excellent, <@{user_id}>! Your collection quest continues.",
                            "Perfect timing, <@{user_id}>! Collection secured!"
                        ]
                        emoji_title = ":tada: Congratulations!"
