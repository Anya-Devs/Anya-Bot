...
class Pokebuttons(discord.ui.View):
    ...
    def __init__(self, alt_names_str=None, name=None, formatted_base_stats=None, type=None, wes=None,
        ...
        print(f'{self.pokemon_name.title()} has gender differ: {self.gender_differ}')
        if self.gender_differ:
          if self.pokemon_name.lower() == "eevee":
            try:
                male_button = discord.ui.Button(label="♂", style=discord.ButtonStyle.gray, custom_id="Pokemon_Male_Button")
                male_button.callback = self.on_button_click
                self.add_item(male_button)

                female_button = discord.ui.Button(label="♀", style=discord.ButtonStyle.gray, custom_id="Pokemon_Female_Button")
                female_button.callback = self.on_button_click
                self.add_item(female_button)
                
                print("Added male and female buttons")
            except Exception as e:
                print(f"Error adding buttons: {e}")
        else:
            print("False: Gender Button have not added.")
    ...
    @discord.ui.button(label="Evolutions", style=discord.ButtonStyle.green, custom_id="Pokemon_Evolutions_Button")
    ...
    @discord.ui.button(label="Duelistics", style=discord.ButtonStyle.blurple, custom_id="Pokemon_Duel_Stats_Button")
